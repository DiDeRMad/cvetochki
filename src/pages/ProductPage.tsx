...
export const ProductPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-28 sm:pb-32 relative">
      <motion.header 
      ...
      <motion.div 
        ...
        className="px-4 pt-2 -mt-8 relative z-10"
      >
        <div className="bg-card rounded-t-3xl p-6 shadow-soft">
          <h1 className="text-2xl font-bold text-foreground">{product.name}</h1>
          <p className="text-gradient text-2xl font-bold mt-2">
